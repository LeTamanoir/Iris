...
test('supports gzip encoding', function () {
    ...
    expect($client->encoding(Encoding::Gzip)->GetDataTypes($request, $reply1)->code)->toBe(Code::OK);
    expect($client->encoding(Encoding::Identity)->GetDataTypes($request, $reply2)->code)->toBe(Code::OK);
